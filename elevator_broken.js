...
class Elevator {
    ...
    constructor(){
        ...
        this.floorsPassengers = // Here should be some data structure
    ...
    registerPassengers(listOfPassengers){
        // Here we should create initialize initial structure 
        // in order to hold floors => [passengers]
        // so, what method should be called here?

        while (
            this.isThereStillPlaceForAnybody() && 
			this.isThereAnybodyInside(listOfPassengers)
        ){
            this.register(listOfPassengers.doSomethind()//here we should do some operation on passengers that want to enter elevator
                                                        // Tip It's operation upon array                   
        }
    ...
    resetFloorsMap(){
        for (
            ...
            floorIndex <= this.some_constant; //Some value is missing here
            floorIndex++)
        {
    ...
    isThereAnybodyInside(passengers){
        return passengers.length !== // ? what should we compare it to?
    }
